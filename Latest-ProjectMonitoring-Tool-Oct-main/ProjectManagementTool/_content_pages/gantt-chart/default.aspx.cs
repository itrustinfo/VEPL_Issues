                ...
                if (dsworkpackage.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (ds.Tables[0].Rows[i]["StartDate"].ToString() != "" && ds.Tables[0].Rows[i]["PlannedEndDate"].ToString() != "")
                        {
                            ...
                            else if (ds.Tables[0].Rows[i]["Status"].ToString() == "Not Started")
                            {
                                DelayedTask = dbgetdata.Check_Task_is_Delayed_Notstarted(new Guid(ds.Tables[0].Rows[i]["TaskUID"].ToString())) > 0 ? true : false;
                            }
                            ...
                            {
                                pClass = ds.Tables[0].Rows[i]["Status"].ToString() == "Completed" ? "gtaskgreen" : (ds.Tables[0].Rows[i]["Status"].ToString() == "In-Progress" && !DelayedTask) ? "gtaskblue" : (ds.Tables[0].Rows[i]["Status"].ToString() == "In-Progress" && DelayedTask) ? "gtaskred" : (ds.Tables[0].Rows[i]["Status"].ToString() == "Not Started" && DelayedTask) ? "gtaskpurple" : "gtaskyellow";
                                //
                                pNotes = ds.Tables[0].Rows[i]["Status"].ToString() == "Completed" ? "Completed" : (ds.Tables[0].Rows[i]["Status"].ToString() == "In-Progress" && !DelayedTask) ? "In-Progress" : (ds.Tables[0].Rows[i]["Status"].ToString() == "In-Progress" && DelayedTask) ? "In-Progress & Delayed" : (ds.Tables[0].Rows[i]["Status"].ToString() == "Not Started" && DelayedTask) ? "Not Started & Delayed" : "Not Started";
                            }
                            ...
                            for (int j = 0; j < dsSecond.Tables[0].Rows.Count; j++)
                            {
                                if (dsSecond.Tables[0].Rows[j]["StartDate"].ToString() != "" && dsSecond.Tables[0].Rows[j]["PlannedEndDate"].ToString() != "")
                                {
                                    ...
                                    else if (dsSecond.Tables[0].Rows[j]["Status"].ToString() == "P")
                                    {
                                        DelayedTask = dbgetdata.Check_Task_is_Delayed_Notstarted(new Guid(dsSecond.Tables[0].Rows[j]["TaskUID"].ToString())) > 0 ? true : false;
                                    }
                                    ...
                                    {
                                        pClass = dsSecond.Tables[0].Rows[j]["Status"].ToString() == "C" ? "gtaskgreen" : (dsSecond.Tables[0].Rows[j]["Status"].ToString() == "I" && !DelayedTask) ? "gtaskblue" : (dsSecond.Tables[0].Rows[j]["Status"].ToString() == "I" && DelayedTask) ? "gtaskred" : (dsSecond.Tables[0].Rows[j]["Status"].ToString() == "P" && DelayedTask) ? "gtaskpurple" : "gtaskyellow";
                                        //
                                        pNotes = dsSecond.Tables[0].Rows[j]["Status"].ToString() == "C" ? "Completed" : (dsSecond.Tables[0].Rows[j]["Status"].ToString() == "I" && !DelayedTask) ? "In-Progress" : (dsSecond.Tables[0].Rows[j]["Status"].ToString() == "I" && DelayedTask) ? "In-Progresss & Delayed" : (dsSecond.Tables[0].Rows[j]["Status"].ToString() == "P" && DelayedTask) ? "Not Started & Delayed" : "Not Started";
                                    }
                                    ...
                                    for (int k = 0; k < dsThird.Tables[0].Rows.Count; k++)
                                    {
                                        if (dsThird.Tables[0].Rows[k]["StartDate"].ToString() != "" && dsThird.Tables[0].Rows[k]["PlannedEndDate"].ToString() != "")
                                        {
                                            ...
                                            {
                                                pClass = dsThird.Tables[0].Rows[k]["Status"].ToString() == "C" ? "gtaskgreen" : (dsThird.Tables[0].Rows[k]["Status"].ToString() == "I" && !DelayedTask) ? "gtaskblue" : (dsThird.Tables[0].Rows[k]["Status"].ToString() == "I" && DelayedTask) ? "gtaskred" : (dsThird.Tables[0].Rows[k]["Status"].ToString() == "P" && DelayedTask) ? "gtaskpurple" : "gtaskyellow";
                                                //
                                                //
                                                pNotes = dsThird.Tables[0].Rows[k]["Status"].ToString() == "C" ? "Completed" : (dsThird.Tables[0].Rows[k]["Status"].ToString() == "I" && !DelayedTask) ? "In-Progress" : (dsThird.Tables[0].Rows[k]["Status"].ToString() == "I" && DelayedTask) ? "In-Progress & Delayed" : (dsThird.Tables[0].Rows[k]["Status"].ToString() == "P" && DelayedTask) ? "Not Started & Delayed" : "Not Started";
                                            ...
                                            for (int l = 0; l < dsFourth.Tables[0].Rows.Count; l++)
                                            {
                                                if (dsFourth.Tables[0].Rows[l]["StartDate"].ToString() != "" && dsFourth.Tables[0].Rows[l]["PlannedEndDate"].ToString() != "")
                                                {
                                                    ...
                                                    else if (dsFourth.Tables[0].Rows[l]["Status"].ToString() == "P")
                                                    {
                                                        DelayedTask = dbgetdata.Check_Task_is_Delayed_Notstarted(new Guid(dsFourth.Tables[0].Rows[l]["TaskUID"].ToString())) > 0 ? true : false;
                                                    }
                                                    ...
                                                    {
                                                        pClass = dsFourth.Tables[0].Rows[l]["Status"].ToString() == "C" ? "gtaskgreen" : (dsFourth.Tables[0].Rows[l]["Status"].ToString() == "I" && !DelayedTask) ? "gtaskblue" : (dsFourth.Tables[0].Rows[l]["Status"].ToString() == "I" && DelayedTask) ? "gtaskred" : (dsFourth.Tables[0].Rows[l]["Status"].ToString() == "P" && DelayedTask) ? "gtaskpurple" : "gtaskyellow";
                                                        //
                                                        pNotes = dsFourth.Tables[0].Rows[l]["Status"].ToString() == "C" ? "Completed" : (dsFourth.Tables[0].Rows[l]["Status"].ToString() == "I" && !DelayedTask) ? "In-Progress" : (dsFourth.Tables[0].Rows[l]["Status"].ToString() == "I" && DelayedTask) ? "In-Progress & Delayed" : (dsFourth.Tables[0].Rows[l]["Status"].ToString() == "P" && DelayedTask) ? "Not Started & Delayed" : "Not Started";
                                                    }
                                                    ...
                                                    for (int m = 0; m < dsFifth.Tables[0].Rows.Count; m++)
                                                    {
                                                        if (dsFifth.Tables[0].Rows[m]["StartDate"].ToString() != "" && dsFifth.Tables[0].Rows[m]["PlannedEndDate"].ToString() != "")
                                                        {
                                                            ...
                                                            else if (dsFifth.Tables[0].Rows[m]["Status"].ToString() == "P")
                                                            {
                                                                DelayedTask = dbgetdata.Check_Task_is_Delayed_Notstarted(new Guid(dsFifth.Tables[0].Rows[m]["TaskUID"].ToString())) > 0 ? true : false;
                                                            }
                                                            ...
                                                            {
                                                                pClass = dsFifth.Tables[0].Rows[m]["Status"].ToString() == "C" ? "gtaskgreen" : (dsFifth.Tables[0].Rows[m]["Status"].ToString() == "I" && !DelayedTask) ? "gtaskblue" : (dsFifth.Tables[0].Rows[m]["Status"].ToString() == "I" && DelayedTask) ? "gtaskred" : (dsFifth.Tables[0].Rows[m]["Status"].ToString() == "P" && DelayedTask) ? "gtaskpurple" : "gtaskyellow";
                                                                //
                                                                pNotes = dsFifth.Tables[0].Rows[m]["Status"].ToString() == "C" ? "Completed" : (dsFifth.Tables[0].Rows[m]["Status"].ToString() == "I" && !DelayedTask) ? "In-Progress" : (dsFifth.Tables[0].Rows[m]["Status"].ToString() == "I" && DelayedTask) ? "In-Progress & Delayed" : (dsFifth.Tables[0].Rows[m]["Status"].ToString() == "P" && DelayedTask) ? "Not Started & Delayed" : "Not Started";
