                        ...
                        <div class="col-lg-6 col-xl-10 form-group">
                            <div class="row" style="text-align:center;">
                                 <div class="col-md-6 col-xl-2 mb-2">
                                    <div class="card">
                                        <div class="card-body" id="divTotal" runat="server" visible="false">
                                            <b style="font-size:large;"><a href="/_content_pages/issues?status=">Total Number</a></b>
                                            <br />
                                        ...
                                        <div class="card-title">
                                            <div class="d-flex justify-content-between">
                                                 <div class="col-md-6 col-lg-4 form-group" style="margin-left:0px;padding-left:0px">
                                                   <%-- <label class="sr-only" for="DDLProject">Project</label>--%>
                                                    <div class="input-group" id="DivUser" runat="server">
                                                ...
                                                <div>
                                                   <a id="AddIssues" runat="server" href="/_modal_pages/add-issues.aspx" class="showIssueModal"><asp:Button ID="Button2" runat="server" Text="+ Add Files" CssClass="btn btn-primary"></asp:Button></a>
                                                    <a id="ViewAllIssues" runat="server" href="/_modal_pages/preview-issue-documents.aspx" class="IssueImagePreview"><asp:Button ID="Button1" runat="server" Text="View All Images" CssClass="btn btn-primary"></asp:Button></a>
                                                    <asp:Button ID="btnDownloadAll" runat="server" Text="Download All Images" CssClass="btn btn-primary" OnClick="btnDownloadAll_Click" Visible="true" OnClientClick="checkbutton();"></asp:Button>
                                                </div>
                                            </div>
                                        </div>
                                        <div style="text-align:center"><asp:Label ID="lblMessage" runat="server" Text="Please wait processing this may take some time......." ForeColor="Red" Font-Bold="true" style="display:none"></asp:Label>
                                            <asp:LinkButton ID="lnldownloadFile" runat="server" Visible="false" OnClick="lnldownloadFile_Click" Font-Bold="true">File is Ready Click here to download</asp:LinkButton>
                                                ...
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        ...
                                                        <asp:BoundField DataField="Issue_Description" HeaderText="Issue Description&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" HeaderStyle-Width="30%" ItemStyle-Width="30%" Visible="false">
                                                            <HeaderStyle HorizontalAlign="Left" />
...
<ItemStyle Width="20%"></ItemStyle>
                                                ...
                                                <HeaderStyle HorizontalAlign="Left" />
                                                    ...
                                                    <ItemStyle CssClass="hiddencol"></ItemStyle>
                                                        ...
                                                        <asp:TemplateField HeaderText="Reply By" Visible="false">
                                                            <ItemTemplate>
                                        ...
                                        <div id="printreport" runat="server" visible="false" style="text-align:right;padding-top:10px">
                                         <input type="button" value="Print Report" class="btn btn-primary" onclick="PrintDiv('myDiv')" style="display:none" />
                                        </div>
                                        </div>
                                    </div>
