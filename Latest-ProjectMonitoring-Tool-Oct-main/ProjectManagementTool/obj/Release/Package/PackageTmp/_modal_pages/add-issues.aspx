                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group" style="display:none">
                        <label class="lblCss" for="txtIssue_Description">Issue Description</label> &nbsp;<span style="color:red; font-size:1.1rem;">*</span>
                         <asp:TextBox ID="txtIssue_Description" runat="server" TextMode="MultiLine" CssClass="form-control" Height="120px"></asp:TextBox>
                    </div>
                     <div class="form-group">
                        <label class="lblCss" for="txtRefNumber">Remarks</label>&nbsp;<span style="color:red; font-size:1.1rem;">*</span>
                        <asp:TextBox ID="txtRemarks" CssClass="form-control" TextMode="MultiLine" required runat="server" ClientIDMode="Static" Height="120px"></asp:TextBox>
                    </div>
                    <div class="form-group">
